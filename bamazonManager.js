...
connection.connect(function (err) {
    ...
    console.log("\033[32m", "Welcome to Bamazon Manager Section NodeJs App.", "\x1b[0m\n");
    console.log("\033[32m", "Select below options to manage your store:", "\x1b[0m\n");
    ...
    // INSERT INTO products (department_id,department_name )
...
function lowInventory() {
    ...
    connection.query("SELECT * FROM products", function (err, res) {
        ...
        if (!low_Inv.length) {
            ...
            console.log("\033[35m", "No Item Below Inventory Criteria, [Criteria = ITEM QUANTIRY < 6]", "\x1b[0m\n")
        }
